...
if __name__ == '__main__':
    ...
    '''
    if len(sys.argv) < 3 or sys.argv[2] not in algos.ALGOS:
        print('Syntax: tester.py <maze file> <algorithm>')
        print(f'Known algorithm: {", ".join(algos.ALGOS.keys())}')
        print('No algorithm or incorrect algorithm specified, defaulting to dfs')
        algo = 'dfs'
    else:
    ...
    testrobot = algos.ALGOS[algo](testmaze.dim)
